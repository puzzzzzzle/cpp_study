...
double Demo1(int i) {
  ...
  cout << "Demo1 has a return value with type is double and value is -1.5."
       << endl;
  return -1.5;
}
...
bool Demo2() {
  ...
  cout << "Demo2 has a return value with type is bool and value is true."
       << endl;
  return true;
}
...
TEST(AOP, test1) {
  ...
  cout
      << "Ret: "
      << (AOP<decltype(Demo1(0)), AspectDemo, TimeElapsedAspect, LoggingAspect>(
             Demo1, 12))
      << endl;
  cout << endl;
