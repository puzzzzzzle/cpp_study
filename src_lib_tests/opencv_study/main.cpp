...
//    fakeBin(&bin, 400, 300);
//    bin.m_sideLen = 10;
//    //    ASSERT_EQ(StaticGeographyConventHandle::LoadBin(PIC_BASE +
//    "/in.data", &bin), 0); std::map<int, Scalar> colors{}; colors[1] =
//    ConvArr::GetRGBA(0xFF4500); ConvArr::PrintBin(mat, bin, bin.m_sideLen,
//    colors); ASSERT_TRUE(imwrite(PIC_BASE + "/test.jpg", mat));
//}
//
// TEST(conv_test, conv) {
//    Mat mat(3000, 4000, CV_8UC3, ConvArr::GetRGBA(0xBBFFFF));
...
//    bin.m_sideLen = 10;
//
//    ASSERT_EQ(StaticGeographyConventHandle::LoadStaticConfig(PIC_BASE +
//    "/in.data", &bin), 0); std::map<int, Scalar> colors{}; colors[1] =
//    ConvArr::GetRGBA(0xFF4500);
//
//    ConvArr::PrintBin(mat, bin, bin.m_sideLen, colors);
//    ConvArr::DrawBorder(mat, Point(0, 0), Point(2048, 2048),
//    ConvArr::GetRGBA(0x4876FF), 3);
//
//    ConvArr::FlipMat(&mat);
//
...
//    "/in.data", &bin), 0); std::map<int, Scalar> colors{}; colors[1] =
//    ConvArr::GetRGBA(0xFF4500); ConvArr::PrintBin(mat, bin, bin.m_sideLen,
//    colors); ConvArr::DrawBorder(mat, Point(0, 0), Point(2048, 2048),
//    ConvArr::GetRGBA(0x4876FF), 3);
//
//    ConvArr::FlipMat(&mat);
//
