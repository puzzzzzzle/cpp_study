...
int main(int argc, char **argv) {
  ...
  try {
    ...
    if (vm.count("int")) {
      cout << "int was set to " << vm["int"].as<int>() << ".\n";
    } else {
      cout << "int was not set.\n";
    }

    if (vm.count("double")) {
      cout << "double was set to " << vm["double"].as<double>() << ".\n";
    } else {
      cout << "double was not set.\n";
    }

    if (vm.count("float")) {
      cout << "float was set to " << vm["float"].as<float>() << ".\n";
    } else {
      cout << "float was not set.\n";
    }

    if (vm.count("string")) {
      cout << "string was set to " << vm["string"].as<string>() << ".\n";
    } else {
    ...
    if (vm.count("vector")) {
      ...
      //            }
      //            cout << "]";
      cout << "vector string are: " << vm["vector"].as<vector<string>>()
           << "\n";
    } else {
