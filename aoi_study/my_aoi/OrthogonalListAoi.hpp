...
public:
    ...
    typedef typename IAoi<NumberT, ObjectT, IDoubleNode<NumberT, ObjectT, AutoDelete>, AutoDelete>::Point Point;
    typedef typename IAoi<NumberT, ObjectT, IDoubleNode<NumberT, ObjectT, AutoDelete>, AutoDelete>::BaseNode BaseNode;
...
public:
    ...
    virtual std::vector<std::pair<Node *, bool>>
    QueryInsideRegion(Node *pnode, NumberT xSize, NumberT ySize) override
    {
    ...
    virtual std::vector<std::pair<Node *, bool>>
    QueryInsidespace(NumberT xStart, NumberT yStart, NumberT xSize, NumberT ySize) override
    {
        std::vector<std::pair<Node *, bool>> result;
        // 往后找
        DoubleNode *cur = _head->xNext;
