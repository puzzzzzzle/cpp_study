...
0000000000001040 <_start>:
    ...
    1058:	48 8d 3d e8 00 00 00 	lea    0xe8(%rip),%rdi        # 1147 <main>
...
0000000000001129 <_Z9para_passicdPv>:
    1129:	f3 0f 1e fa          	endbr64 
    112d:	55                   	push   %rbp
    112e:	48 89 e5             	mov    %rsp,%rbp
    1131:	89 7d fc             	mov    %edi,-0x4(%rbp)
    1134:	89 f0                	mov    %esi,%eax
    1136:	f2 0f 11 45 f0       	movsd  %xmm0,-0x10(%rbp)
    113b:	48 89 55 e8          	mov    %rdx,-0x18(%rbp)
    113f:	88 45 f8             	mov    %al,-0x8(%rbp)
...
0000000000001147 <main>:
    ...
    1156:	48 89 75 f0          	mov    %rsi,-0x10(%rbp)
    115a:	48 8b 05 a7 0e 00 00 	mov    0xea7(%rip),%rax        # 2008 <_IO_stdin_used+0x8>
    1161:	ba 00 00 00 00       	mov    $0x0,%edx
    1166:	66 48 0f 6e c0       	movq   %rax,%xmm0
    116b:	be 78 00 00 00       	mov    $0x78,%esi
    1170:	bf 01 00 00 00       	mov    $0x1,%edi
    1175:	e8 af ff ff ff       	call   1129 <_Z9para_passicdPv>
